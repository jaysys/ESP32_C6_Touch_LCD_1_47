 ...
 * Size: 96 px
 * Bpp: 4
 * Opts: --bpp 4 --size 96 --no-compress --stride 1 --align 1 --font font_montserrat_24.ttf --range 48-58 --format lvgl -o montserrat_96.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 16870, .adv_w = 326, .box_w = 11, .box_h = 51, .ofs_x = 5, .ofs_y = 0}
};
